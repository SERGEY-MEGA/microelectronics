...
PACKAGES = [
    ...
    {
        "base_dir": FINAL_DIR / "Общий_отчет_на_троих",
        "performers": [
            "Мегерян Сергей Сергеевич",
            "Арунова Анастаия Дмитриевна",
            "Арунова Маргарита Дмитриевна",
        ],
        "title": "Общий комплект отчетов на троих студентов",
    },
]
